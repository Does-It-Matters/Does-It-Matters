...
<br>- 출력 어댑터들을 모듈로 분리
<br><br><b>3) MSA 전환</b>
<br>- Micro Answer에서 좀 더 확장성있게 진행 
...
2) <b>주요 특징</b>
<br> 일반 사용자 사용 용도(게시판 이용) 외 운영자 기능 개발 중단 예정 (전용 서비스로 분리하여 진행 중)
